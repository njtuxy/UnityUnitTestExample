...
namespace Ability_Prefab_Tests
{
	...
	[TestFixture]
	public class Summon_Abilities_Tests {

	
		static object[] prefabs = 
		{
			new object[] {"Ability_SummonCompanion.prefab"},
			new object[] {"Ability_SummonCreature.prefab"},
			new object[] {"Ability_SummonCreature_DPS.prefab"},
			new object[] {"Zodiac_Summon_GoldDragon.prefab"},
			new object[] {"Zodiac_Summon_Placeholder.prefab"}
