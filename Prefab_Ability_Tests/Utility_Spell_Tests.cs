...
namespace Ability_Prefab_Tests
{
	...
	[TestFixture]
	public class Utility_Spell_Tests {
		
		
		static object[] prefabs = 
		{
			new object[] {"Spell_Attract.prefab"},
			new object[] {"Spell_Repulsor.prefab"},
			new object[] {"Spell_Teleport.prefab"},
			new object[] {"Spell_TrueSight.prefab"},
		};
