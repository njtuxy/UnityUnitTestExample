...
namespace Ability_Prefab_Tests
{
	...
	[TestFixture]
	public class AOE_Damage_Spell_Tests {
		
		
		static object[] prefabs = 
		{
			new object[] {"Spell_AOE_Damage.prefab"},
			new object[] {"Spell_AOE_Damage_Large.prefab"},
			new object[] {"Spell_ProgressiveAOE_Damage.prefab"},
			new object[] {"Spell_ProgressiveAOE_Damage_Small.prefab"},
			new object[] {"Spell_Projectile_AOE_Damage.prefab"}
